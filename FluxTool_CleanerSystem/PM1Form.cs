    ...
    public partial class PM1Form : UserControl
    {
        ...
        public void Display()
        {
            ...
            */
            ...
            if (Global.GetDigValue((int)DigInputList.CH1_Tool_Detect2_i) == "On")
            {
                if (!bToolSns2)
                {
            ...
            if (Global.digSet.curDigSet[(int)DigOutputList.CH1_Cylinder_Fwd_o] == "On")
                textBoxCylinderFwdBwd.Text = "Forward";
            else if (Global.digSet.curDigSet[(int)DigOutputList.CH1_Cylinder_Bwd_o] == "On")
                textBoxCylinderFwdBwd.Text = "Backward";
            else
                textBoxCylinderFwdBwd.Text = "None";
        ...
        private void Digital_Click(object sender, EventArgs e)
        {
            ...
            switch (strTmp)
            {
                case "0":
                    {
                        digitalDlg.Init2("None", "Close", "Open", "CH1 Door close/open");
                ...
                case "2":
                    {
                        digitalDlg.Init("Close", "Open", "CH1 Side Air Valve");
                        if (digitalDlg.ShowDialog() == DialogResult.OK)
                        {
                            if (digitalDlg.m_strResult == "Close")
                            {
                ...
                case "4":
                    {
                        digitalDlg.Init("Close", "Open", "CH1 Air knife");
                        if (digitalDlg.ShowDialog() == DialogResult.OK)
                        {
                            if (digitalDlg.m_strResult == "Close")
                            {
                ...
                case "5":
                    {
                        digitalDlg.Init("Close", "Open", "CH1 Water Valve");
                        if (digitalDlg.ShowDialog() == DialogResult.OK)
                        {
                            if (digitalDlg.m_strResult == "Close")
                            {
                ...
                case "6":
                    {
                        digitalDlg.Init2("None", "Backward", "Forward", "CH1 Cylinder Fwd/Bwd");
                        if (digitalDlg.ShowDialog() == DialogResult.OK)
                        {
                            if (digitalDlg.m_strResult == "None")
                            {
                ...
                case "7":
                    {
                        digitalDlg.Init("Down", "Up", "CH1 Pin Up/Down");
                        if (digitalDlg.ShowDialog() == DialogResult.OK)
                        {
        ...
        private void checkBoxCH1ToolCheck_Click(object sender, EventArgs e)
        {            
            if (Define.bDontCheckTool[module])
