    ...
    public partial class PM2Form : UserControl
    {
        ...
        public void Display()
        {
            ...
            */
            ...
            if (Global.GetDigValue((int)DigInputList.CH2_Tool_Detect2_i) == "On")
            {
                if (!bToolSns2)
                {
            ...
            if (Global.digSet.curDigSet[(int)DigOutputList.CH2_Cylinder_Fwd_o] == "On")
                textBoxCylinderFwdBwd.Text = "Forward";
            else if (Global.digSet.curDigSet[(int)DigOutputList.CH2_Cylinder_Bwd_o] == "On")
                textBoxCylinderFwdBwd.Text = "Backward";
            else
                textBoxCylinderFwdBwd.Text = "None";
        ...
        private void Digital_Click(object sender, EventArgs e)
        {
            ...
            switch (strTmp)
            {
                case "0":
                    {
                        digitalDlg.Init2("None", "Close", "Open", "CH2 Door close/open");
                ...
                case "2":
                    {
                        digitalDlg.Init("Close", "Open", "CH2 Side Air Valve");
                        if (digitalDlg.ShowDialog() == DialogResult.OK)
                        {
                            if (digitalDlg.m_strResult == "Close")
                            {
                                Global.SetDigValue((int)DigOutputList.CH2_Side_AirValve_o, (uint)DigitalOffOn.Off, ModuleName);
                            }
                            else
                            {
                                Global.SetDigValue((int)DigOutputList.CH2_Side_AirValve_o, (uint)DigitalOffOn.On, ModuleName);
                            }
                        }
                    }
                    break;                
                ...
                case "6":
                    {
                        digitalDlg.Init2("None", "Backward", "Forward", "CH2 Cylinder Fwd/Bwd");
                        if (digitalDlg.ShowDialog() == DialogResult.OK)
                        {
                            if (digitalDlg.m_strResult == "None")
                            {
                                Global.SetDigValue((int)DigOutputList.CH2_Cylinder_Fwd_o, (uint)DigitalOffOn.Off, ModuleName);
                                Global.SetDigValue((int)DigOutputList.CH2_Cylinder_Bwd_o, (uint)DigitalOffOn.Off, ModuleName);
                            }
                            else if (digitalDlg.m_strResult == "Backward")
                            {
                                ...
                                Global.SetDigValue((int)DigOutputList.CH2_Cylinder_Fwd_o, (uint)DigitalOffOn.Off, ModuleName);
                                Global.SetDigValue((int)DigOutputList.CH2_Cylinder_Bwd_o, (uint)DigitalOffOn.On, ModuleName);
                            }
                            else if (digitalDlg.m_strResult == "Forward")
                            {
                                Global.SetDigValue((int)DigOutputList.CH2_Cylinder_Pwr_o, (uint)DigitalOffOn.On, ModuleName);

                                Global.SetDigValue((int)DigOutputList.CH2_Cylinder_Fwd_o, (uint)DigitalOffOn.On, ModuleName);
                                Global.SetDigValue((int)DigOutputList.CH2_Cylinder_Bwd_o, (uint)DigitalOffOn.Off, ModuleName);
                            }
                        }
                    }
        ...
        private void checkBoxCH2ToolCheck_Click(object sender, EventArgs e)
        {
            if (Define.bDontCheckTool[module])
